...
using System;
namespace KiotaFruit.Fruits.Item {
    /// <summary>
    /// Builds and executes requests for operations under \fruits\{name}
    /// </summary>
    public class WithNameItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithNameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fruits/{name}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithNameItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithNameItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fruits/{name}", rawUrl) {
        }
        /// <summary>
        /// Get a fruit by name
        /// </summary>
...
#nullable enable
        public async Task<Fruit?> GetAsync(Action<WithNameItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Fruit> GetAsync(Action<WithNameItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
